...
coef_df %>%
  ...
  make_plot_all(height = 3,
                width = 8,
                file_name = "figure_02plannedcompleted.png")
...
stargazer(lib_dem_val_index.full.lm,
          ...
          add.lines = list(
            ...
            c("Buffer",buffer)),
          out=file.path(tables_file_path, "table_02plannedcompleted_full.tex"))
...
stargazer(lib_dem_val_index.restricted.lm,
          ...
          add.lines = list(
            ...
            c("Country Fixed Effects", "Y"),
            c("Buffer",buffer)),
          out=file.path(tables_file_path, "table_02plannedcompleted_restricted.tex"))
